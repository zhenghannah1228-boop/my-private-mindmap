...
export const BUILTIN_JARGON: Jargon[] = [
  ...
  { id: 'p-ji', term: 'P 级 / P7 标准', category: '考核体系', plain: '专业序列职级,P7 是「高级」分水岭:能带方向、影响决策。P8+ 才叫专家/架构师。不同公司叫法不同(腾讯 T、字节 1-15),但「P7 标准」已成行业通用说法。', example: '他是 P7,可以直接跟业务 PK 方案。' },
  { id: '3-25', term: '3.25 绩效', category: '考核体系', plain: '阿里绩效「基本符合」档(5→4→3.75→3.25→3→2),无奖金/涨薪极少;连续几次基本是变相 PIP。「被 3.25」已成动词,泛指被绩效打低、暗示可以走人。', example: '这季度又被 3.25 了,感觉在被优化。' },
  { id: 'roi', term: 'ROI', category: '考核体系', plain: '投资回报率:(收益-成本)/成本×100%。大厂里多用来否定别人方案:「这个需求 ROI 太低,先排后面。」', example: '这个活动 ROI 怎么样?值得做吗?' },
  { id: 'dao-gua', term: '倒挂', category: '考核体系', plain: '新员工薪资比同岗老员工还高,老员工薪资「倒着挂」。市场水涨船高但内部涨薪慢,是让老员工最气的现象。', example: '我干了三年,新来的应届生比我还高,典型倒挂。' },

  // 增长运营(补充)
  { id: 'sku', term: 'SKU', category: '增长运营', plain: '最小库存单位,指一个具体规格的商品。大厂泛化成「产品/功能的具体形态」,随便什么都叫 SKU。', example: '这个方向我们先上几个 SKU 试试水。' },
  { id: 'gmv', term: 'GMV', category: '增长运营', plain: '平台总交易额,含未付款、退款、刷单水分。电商大厂爱拿它对外展示,因为比实际营收好看很多。', example: '双十一 GMV 破了新高,但利润另说。' },

  // 效率提升(补充)
  { id: 'gao-bing-fa', term: '高并发', category: '效率提升', plain: '系统同一时刻处理大量请求的场景(如双十一秒杀)。非技术人员也爱用来装专业。', example: '这个方案能抗高并发吗?' },

  // 组织协作(补充)
  { id: 'oa', term: 'OA', category: '组织协作', plain: '公司内部审批/办公系统(钉钉/飞书里的审批流)。「走 OA」= 提交线上审批留记录。', example: '报销记得走 OA,别找我线下签。' },
];
